...
const NewsletterSection = () => {
  return (
    ...
    //         {/* gradient bg */}
    //         <div className='absolute top-0 right-0 w-1/2 h-full bg-blue-700 bg-clip-content clip-path-slant hidden md:block'></div>
    ...
    //            <input type="text"  className='w-full bg-white sm:w-auto md:w-80 px-4 sm:px-6 py-3 sm:py-4 rounded-xl sm:rounded-l-xl sm:rounded-r-none focus:outline'/>
    //             <button>
    //                 <span className='w-full sm:w-auto cursor-pointer bg-green-500 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-xl sm:rounded-l-none sm:rounded-r-lg flex'>Discover</span>
