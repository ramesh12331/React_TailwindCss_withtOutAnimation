...
const Hero = () => {
  return (
    <section id='home' className='container flex flex-col items-center md:flex-row justify-between mx-auto pb-6 px-4 pt-44 lg:px-8 sm:px-6'>
      {/* left col */}
      <div className='w-full md:1/2 space-y-8'>
        ...
        <h1 className='text-4xl md:text-5xl lg:text-5xl font-bold leading-tight'>We boost the growth for 
            <span className='text-blue-600 relative inline-block'>Startup to Fortune 500 <span className='absolute bottom-0 left-0 w-full h-0.5 bg-blue-200/60'></span></span> 
             Companies <span className='inline-block ml-2 animate-pulse'>⏱️</span></h1>
      ...
      {/* right col */}
      <div className='w-full md:1/2 md:mt-0 pl-0 md:pl-12'>
        <div>
