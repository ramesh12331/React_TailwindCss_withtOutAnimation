      ...
      <div className='max-w-xl mx-auto'>
        ...
        <div className='relative px-4'>
          <div className='flex items-center gap-2'>
            ...
            <input className='flex-1 h-2 bg-gray-200 rounded-lg appearence-none cursor-pointer' type="range" min='1' max="50" value={productCount} onChange={(e)=>setProductCount(parseInt(e.target.value))}/>
